...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', default='config/official/train/tardal-dt.yaml', help='config file path')
    ...
    logging.basicConfig(level=logging.INFO, format=log_f)
    logging.info(f'download success')
